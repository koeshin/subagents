---
name: starter
description: Static web development skill for beginners and non-developers.
---
...
- **원본 에이전트**: bkit:starter-guide
- **사용자 호출 가능**: true
- **PDCA 단계**: plan
- **작업 템플릿**: "[Init-Starter] {feature}"
- **다음 스킬**: phase-1-schema
- **임포트**: ./templates/design-starter.template.md
