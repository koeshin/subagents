...
description: Skill for deploying to production environment.
---
...
- **원본 에이전트**: bkit:infra-architect
- **사용자 호출 가능**: false
- **PDCA 단계**: act
- **작업 템플릿**: "[Phase-9] {feature}"
- **임포트**: ./templates/pipeline/phase-9-deployment.template.md
