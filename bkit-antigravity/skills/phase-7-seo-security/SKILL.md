...
- **원본 에이전트 매핑**: default: bkit:code-analyzer, security: bkit:security-architect
- **사용자 호출 가능**: false
- **PDCA 단계**: do
- **작업 템플릿**: "[Phase-7] {feature}"
- **다음 스킬**: phase-8-review
- **임포트**: ./templates/pipeline/phase-7-seo-security.template.md
