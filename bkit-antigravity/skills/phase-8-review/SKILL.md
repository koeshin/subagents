---
name: phase-8-review
description: Skill for verifying overall codebase quality and gap analysis.
---
...
- **원본 에이전트 매핑**: default: bkit:code-analyzer, validate: bkit:design-validator, gap: bkit:gap-detector, qa: bkit:qa-strategist, team: bkit:cto-lead
- **사용자 호출 가능**: false
- **PDCA 단계**: check
- **작업 템플릿**: "[Phase-8] {feature}"
- **다음 스킬**: phase-9-deployment
