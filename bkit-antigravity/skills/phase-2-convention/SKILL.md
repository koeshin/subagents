...
description: Skill for defining coding rules and conventions.
---
...
- **사용자 호출 가능**: false
- **PDCA 단계**: plan
- **작업 템플릿**: "[Phase-2] {feature}"
- **다음 스킬**: phase-3-mockup
- **임포트**: ./templates/pipeline/phase-2-convention.template.md, ./templates/shared/naming-conventions.md
