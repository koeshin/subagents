...
description: Skill for building platform-independent design systems.
---
...
- **원본 에이전트 매핑**: default: bkit:pipeline-guide, frontend: bkit:frontend-architect
- **사용자 호출 가능**: false
- **PDCA 단계**: do
- **작업 템플릿**: "[Phase-5] {feature}"
- **다음 스킬**: phase-6-ui-integration
- **임포트**: ./templates/pipeline/phase-5-design-system.template.md
