---
name: phase-4-api
description: Skill for designing and implementing backend APIs.
---
...
- **원본 에이전트**: bkit:qa-monitor
- **사용자 호출 가능**: false
- **PDCA 단계**: do
- **작업 템플릿**: "[Phase-4] {feature}"
- **다음 스킬**: phase-5-design-system
- **임포트**: ./templates/pipeline/phase-4-api.template.md, ./templates/shared/api-patterns.md, ./templates/shared/error-handling-patterns.md
