---
name: phase-1-schema
description: Skill for defining terminology and data structures used throughout the project.
---
...
- **원본 에이전트**: bkit:pipeline-guide
- **사용자 호출 가능**: false
- **PDCA 단계**: plan
- **작업 템플릿**: "[Phase-1] {feature}"
- **다음 스킬**: phase-2-convention
- **임포트**: ./templates/pipeline/phase-1-schema.template.md, ./templates/shared/naming-conventions.md
