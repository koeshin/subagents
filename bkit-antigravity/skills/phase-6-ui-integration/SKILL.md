...
description: Skill for implementing actual UI and integrating with APIs.
---
...
- **사용자 호출 가능**: false
- **PDCA 단계**: do
- **작업 템플릿**: "[Phase-6] {feature}"
- **다음 스킬**: phase-7-seo-security
- **임포트**: ./templates/pipeline/phase-6-ui.template.md
