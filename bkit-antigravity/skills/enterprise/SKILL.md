---
name: enterprise
description: Enterprise-grade system development with microservices, Kubernetes, and Terraform.
---
...
- **원본 에이전트 매핑**: default: bkit:enterprise-expert, infra: bkit:infra-architect, architecture: bkit:enterprise-expert, security: bkit:security-architect, team: bkit:cto-lead
- **사용자 호출 가능**: true
- **PDCA 단계**: plan
- **작업 템플릿**: "[Init-Enterprise] {feature}"
- **다음 스킬**: phase-1-schema
- **임포트**: ./templates/design-enterprise.template.md
