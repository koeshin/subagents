...
description: Security architecture expert agent for vulnerability analysis, authentication
---
...
- **원본 권한 모드**: plan
- **원본 메모리 범위**: project
- **원본 도구**: Read, Glob, Grep, Task(Explore), Task(code-analyzer), WebSearch
- **참조 스킬**: phase-7-seo-security, code-review
