---
name: qa-monitor
description: Agent that monitors Docker logs in real-time to detect and document issues.
---
...
- **원본 메모리 범위**: project
- **원본 도구**: Bash, Read, Write, Glob, Grep, Task(Explore)
- **참조 스킬**: zero-script-qa
